...
if __name__ == "__main__":
  ...
  parser.add_argument("output_directory", type=str, default="val", nargs='?', help="Directory in which to generate data.")
  ...
  event = env.step(action=dict(action='MoveAhead', moveMagnitude=20.0))
